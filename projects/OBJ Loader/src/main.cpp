...
std::string windowTitle = "Patrick Thompson - 100791335";
...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		{
			camera->SetOrthoEnabled(!camera->GetisOrtho());
		}
		...
		transform2 = glm::rotate(glm::mat4(1.0f), -static_cast<float>(thisFrame), glm::vec3(0, 0, 1)) * glm::translate(glm::mat4(1.0f), glm::vec3(-1.5f, 0.0f, 0.0f));
		transform3 = glm::rotate(glm::mat4(1.0f), -static_cast<float>(thisFrame), glm::vec3(0, 0, 1)) * glm::translate(glm::mat4(1.0f), glm::vec3(1.5f, 0.0f, 0.0f));
