...
int main() {
	...
	//View Matrix / Camera
	glm::mat4 view = glm::lookAt(glm::vec3(0, 0, -2), //camera position
		                         glm::vec3(0, 0, 0),  //target
		                         glm::vec3(0, 1, 0)); //up vector

	//model matrix
	glm::mat4 model = glm::mat4(1.0f); //identity matrix - resets matrix
	glm::mat4 MVP = Projection * view * model;

	//handle for model projection matrix (MVP)
