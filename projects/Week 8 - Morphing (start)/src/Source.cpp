/*
Week 8 Tutorial Sample - Created for INFR 2310 at Ontario Tech.
...
int main()
{
	...
	for (int i = 0; i < boiFrames.size(); i++)
	{
		boiEntity.Get<CMorphAnimator>().LoadFrames(boiFrames[i].get());
	}
...
void LoadDefaultResources()
{
	...
	//Start by just loading in our 8 base frames. 
	for (int i = 0; i <= 7; ++i)
	{
